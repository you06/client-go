...
func (an artNode) _findChild4(a *artAllocator, c byte) artNode {
	n4 := an.node4(a)
...
func (an artNode) _findChild16(a *artAllocator, c byte) artNode {
	n16 := an.node16(a)
...
func (an artNode) _findChild48(a *artAllocator, c byte) artNode {
	n48 := an.node48(a)
	if n48.present[c>>n48s]&(1<<(c%n48m)) != 0 {
		return n48.children[n48.keys[c]]
	}
	return nullArtNode
}

func (an artNode) _findChild256(a *artAllocator, c byte) artNode {
	n256 := an.node256(a)
